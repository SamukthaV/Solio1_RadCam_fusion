...
rospy.init_node('image_publisher_back', anonymous=True)

# Create a publisher with the appropriate topic and message type for the image
image_pub = rospy.Publisher('basler_back', Image, queue_size=10)
bridge = CvBridge()

# Create a publisher for bounding box details
bbox_pub = rospy.Publisher('object_topic_back', Float32MultiArray, queue_size=10)

# Create a publisher for the timestamp
time_pub = rospy.Publisher("time_topic_back", String, queue_size=10)
